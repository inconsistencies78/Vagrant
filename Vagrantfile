...
#    gitlab.vm.network "forwarded_port", guest: 22, host: 2522, auto_correct: true #Port freigeschaltet. brauchen wir auch nicht, weil sowieso frei geschaltet. sonst doppelt.
    gitlab.vm.network "forwarded_port", guest: 80, host: 80, auto_correct: true  #Port freigeschaltet
    gitlab.vm.network "forwarded_port", guest: 443, host: 443, auto_correct: true  #Port freigeschaltet
